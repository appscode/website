document.addEventListener("DOMContentLoaded", () => {
  ...
  // after preTag conditionally us margin-top
  marginTopAfterPreTag();
  ...
  lefSidebarFirstElementFontSize();

  // docs page custom anchor tag
  docsPageCustomAnchorTag();

  // docs page right sidebar conditionaly style
  docsPageRightSidebarConditionalStyle();
});
...
// left sidebar menu fontSize
function lefSidebarFirstElementFontSize() {
...
//Docs page headerElement custom anchor tag add
function docsPageCustomAnchorTag() {
...
// docs page right sidebar conditionaly style
function docsPageRightSidebarConditionalStyle() {
  let allHeaders = document.querySelectorAll(
    ".full-info > h2,.full-info > h3,.full-info > h4"
  );
