...
- This document shows how to configure GitHub as Kubernetes authenticator, the configuration for other [authenticators](/products/guard/v0.5.0-rc.1/guides/README) should be similar.
...
- [Guard](/products/guard/v0.5.0-rc.1/setup/install) installed on OS X or Linux
...
It is possible to use guard server DNS address instead of a cluster IP. Please visit [here](/products/guard/v0.5.0-rc.1/setup/install#using-guard-service-name-instead-of-ip-in-authentication-webhook-config-file) to learn the steps and its implications.
