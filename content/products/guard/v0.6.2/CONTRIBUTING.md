...
url: /products/guard/v0.6.2/welcome/contributing/
aliases:
- /products/guard/v0.6.2/CONTRIBUTING/
info:
  version: v0.6.2
---
...
We have a [Developer Guide](/products/guard/v0.6.2/setup/developer-guide/overview) that outlines everything you need to know from setting up your
