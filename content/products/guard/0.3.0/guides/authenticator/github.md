...
Guard installation guide can be found [here](/products/guard/0.3.0/setup/install). To use Github, you need a client cert with `CommonName` set to Github organization name and `Organization` set to `Github`. To ease this process, use the Guard cli to issue a client cert/key pair.
...
![github-token](/products/guard/0.3.0/images/github-token.png)
...
![github-webhook-flow](/products/guard/0.3.0/images/github-webhook-flow.png)
