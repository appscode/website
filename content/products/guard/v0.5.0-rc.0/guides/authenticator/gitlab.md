...
Guard installation guide can be found [here](/products/guard/v0.5.0-rc.0/setup/install). To use Gitlab, you need a client cert with `Organization` set to `Gitlab`. To ease this process, use the Guard cli to issue a client cert/key pair.
...
![gitlab-token](/products/guard/v0.5.0-rc.0/images/gitlab-token.png)
...
![gitlab-webhook-flow](/products/guard/v0.5.0-rc.0/images/gitlab-webhook-flow.png)
