...
## Deploy Guard Server
For detailed instructions follow the guide [here](/products/guard/v0.6.0/setup/install). To generate correct installer YAMLs for Guard server, pass the flags `--google.admin-email` and `--google.sa-json-file`.
...
![google-webhook-flow](/products/guard/v0.6.0/images/google-webhook-flow.png)
```json
{
