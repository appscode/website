...
url: /products/guard/v0.5.0/welcome/contributing/
aliases:
- /products/guard/v0.5.0/CONTRIBUTING/
info:
  version: v0.5.0
---
...
We have a [Developer Guide](/products/guard/v0.5.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your
