...
documentation](/products/guard/0.1.0-rc.5/setup/install-kops) to see differences in setup.
...
```
![github-token](/products/guard/0.1.0-rc.5/images/github-token.png)
...
```
![guard-appscode](/products/guard/0.1.0-rc.5/images/guard-appscode.png)
...
![appscode-token](/products/guard/0.1.0-rc.5/images/appscode-token.png)
