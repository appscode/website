...
url: /products/guard/v0.7.1/welcome/contributing/
aliases:
- /products/guard/v0.7.1/CONTRIBUTING/
info:
  version: v0.7.1
---
...
We have a [Developer Guide](/products/guard/v0.7.1/setup/developer-guide/overview) that outlines everything you need to know from setting up your
