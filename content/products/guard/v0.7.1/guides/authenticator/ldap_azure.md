...
![azure-azure-ADDS](/products/guard/v0.7.1/images/ldap-azure/azure-ADDS.png)

2.  Click the name of the managed domain(for example: appscode.com)

![azure-ADDS-home](/products/guard/v0.7.1/images/ldap-azure/azure-ADDS-home.png)

3.  Click the **Properties** and find the **SECURE LDAP EXTERNAL IP ADDRESS**

![azure-ADDS-properties](/products/guard/v0.7.1/images/ldap-azure/azure-ADDS-properties.png)
...
Guide for Guard installation and PKI initialization are given [here](/products/guard/v0.7.1/setup/install).
