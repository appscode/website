...
## Deploy Guard Server
For detailed instructions follow the guide [here](/products/guard/0.1.4/setup/install). To generate correct installer YAMLs for Guard server, pass the flags `--google.admin-email` and `--google.sa-json-file`.
...
![google-webhook-flow](/products/guard/0.1.4/images/google-webhook-flow.png)
```json
{
