...
[Kops](https://github.com/kubernetes/kops) is a popular installer for production grade Kubernetes clusters. Please start [here](/products/guard/v0.7.0/setup/install) to get an overview of installation steps. This document only shows distinctions during Kops setup of guard.
...
This document only shows difference between kops setup and [here](/products/guard/v0.7.0/setup/install).
