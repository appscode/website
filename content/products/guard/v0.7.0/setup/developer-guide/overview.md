...
> New to Guard? Please start [here](/products/guard/v0.7.0/concepts/README).
...
#### Build Docker images
To build and push your custom Docker image, follow the steps below. To release a new version of Guard, please follow the [release guide](/products/guard/v0.7.0/setup/developer-guide/release).
