...
![operator-metrics](/products/kubed/v0.12.0/images/monitoring/operator-metrics.png)
...
## Next Steps
 - Need to keep configmaps/secrets synchronized across namespaces or clusters? Try [Kubed config syncer](/products/kubed/v0.12.0/guides/config-syncer/).
