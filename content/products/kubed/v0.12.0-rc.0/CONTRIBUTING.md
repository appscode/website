...
url: /products/kubed/v0.12.0-rc.0/welcome/contributing/
aliases:
- /products/kubed/v0.12.0-rc.0/CONTRIBUTING/
info:
...
We have a [Developer Guide](/products/kubed/v0.12.0-rc.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your
