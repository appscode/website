...
Now, deploy Kubed operator in your cluster following the steps [here](/products/kubed/0.7.0-rc.2/setup/install). Once the operator pod is running, janitor operations are applied within one hour.
