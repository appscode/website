...
Now, deploy Kubed operator in your cluster following the steps [here](/products/kubed/0.7.0-rc.1/setup/install). Once the operator pod is running, check your bucket from Google Cloud console. You should see the data from initial snapshot operation.

![GCS Snapshot](/products/kubed/0.7.0-rc.1/images/cluster-snapshot/gcs-snapshot.png)
...
Now, deploy Kubed operator in your cluster following the steps [here](/products/kubed/0.7.0-rc.1/setup/install). Once the operator pod is running, check your bucket from S3 console. You should see the data from initial snapshot operation.
...
Now, deploy Kubed operator in your cluster following the steps [here](/products/kubed/0.7.0-rc.1/setup/install). Once the operator pod is running, check your container from Azure portal. You should see the data from initial snapshot operation.
...
Now, deploy Kubed operator in your cluster following the steps [here](/products/kubed/0.7.0-rc.1/setup/install). Once the operator pod is running, check your container. You should see the data from initial snapshot operation.
...
Now, deploy Kubed operator in your cluster. Since, `snapshotter.local.path` is set to `/var/data`, mount your local volume at that path. You can find example installation scripts below:
 - [Without RBAC](/products/kubed/0.7.0-rc.1/examples/cluster-snapshot/local/without-rbac.yaml)
 - [With RBAC](/products/kubed/0.7.0-rc.1/examples/cluster-snapshot/local/with-rbac.yaml)
...
## Cleaning up
To cleanup the Kubernetes resources created by this tutorial, uninstall Kubed operator following the steps [here](/products/kubed/0.7.0-rc.1/setup/uninstall).


## Next Steps
 - To setup a recycle bin for deleted and/or updated Kubernetes objects, please visit [here](/products/kubed/0.7.0-rc.1/guides/disaster-recovery/recycle-bin).
 - Backup your persistent volumes with [Stash](/products/kubed/0.7.0-rc.1/guides/disaster-recovery/stash).
 ...
 - Want to keep an eye on your cluster with automated notifications? Setup Kubed [event forwarder](/products/kubed/0.7.0-rc.1/guides/cluster-events/).
