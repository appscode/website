...
![telegram-bot](/products/kubed/0.7.0-rc.1/images/event-forwarder/telegram-bot.png)
...
## Next Steps
 - Want to keep an eye on your cluster with automated notifications? Setup Kubed [event forwarder](/products/kubed/0.7.0-rc.1/guides/cluster-events/event-forwarder).
