...
![origin annotation](/products/kubed/0.7.0-rc.1/images/config-syncer/config-origin.png)
...
## Next Steps
 - Learn how to sync config-maps or secrets across multiple cluster [here](/products/kubed/0.7.0-rc.1/guides/config-syncer/inter-cluster).
