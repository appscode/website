...
Now, deploy Kubed in your cluster following the steps [here](/products/kubed/0.7.0-rc.1/setup/install). Once the operator pod is running, go to the next section.
...
## Cleaning up
To cleanup the Kubernetes resources created by this tutorial, uninstall Kubed following the steps [here](/products/kubed/0.7.0-rc.1/setup/uninstall).
