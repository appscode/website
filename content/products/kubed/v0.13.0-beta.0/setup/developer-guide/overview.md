...
#### Build Docker images
To build and push your custom Docker image, follow the steps below. To release a new version of Kubed, please follow the [release guide](/products/kubed/v0.13.0-beta.0/setup/developer-guide/release).
