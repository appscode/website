...
![origin annotation](/products/kubed/v0.13.0-beta.0/images/config-syncer/config-origin.png)
...
To uninstall Kubed operator, please follow the steps [here](/products/kubed/v0.13.0-beta.0/setup/uninstall).

## Next Steps

- Learn how to sync config-maps or secrets across multiple cluster [here](/products/kubed/v0.13.0-beta.0/guides/config-syncer/inter-cluster).
