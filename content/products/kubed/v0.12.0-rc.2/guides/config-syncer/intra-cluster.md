...
![origin annotation](/products/kubed/v0.12.0-rc.2/images/config-syncer/config-origin.png)
...
To uninstall Kubed operator, please follow the steps [here](/products/kubed/v0.12.0-rc.2/setup/uninstall).

## Next Steps

- Learn how to sync config-maps or secrets across multiple cluster [here](/products/kubed/v0.12.0-rc.2/guides/config-syncer/inter-cluster).
