...
#### Build Docker images
To build and push your custom Docker image, follow the steps below. To release a new version of Kubed, please follow the [release guide](/products/kubed/0.7.0-rc.0/setup/developer-guide/release).
