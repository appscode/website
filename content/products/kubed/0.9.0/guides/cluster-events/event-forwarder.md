...
![PVC Added Notification](/products/kubed/0.9.0/images/event-forwarder/pvc-added-notification.png)
...
![Pod Failed](/products/kubed/0.9.0/images/event-forwarder/pod-fail-1.png)
![Pod FailedSync](/products/kubed/0.9.0/images/event-forwarder/pod-fail-2.png)
...
## Next Steps
 - See the list of supported notifiers [here](/products/kubed/0.9.0/guides/cluster-events/notifiers).
