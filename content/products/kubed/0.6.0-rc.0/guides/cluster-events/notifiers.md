...
![telegram-bot](/products/kubed/0.6.0-rc.0/images/event-forwarder/telegram-bot.png)
...
## Next Steps
 - Want to keep an eye on your cluster with automated notifications? Setup Kubed [event forwarder](/products/kubed/0.6.0-rc.0/guides/cluster-events/event-forwarder).
