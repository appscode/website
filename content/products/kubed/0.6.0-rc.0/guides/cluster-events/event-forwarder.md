...
![PVC Added Notification](/products/kubed/0.6.0-rc.0/images/event-forwarder/pvc-added-notification.png)
...
![Pod Failed](/products/kubed/0.6.0-rc.0/images/event-forwarder/pod-fail-1.png)
![Pod FailedSync](/products/kubed/0.6.0-rc.0/images/event-forwarder/pod-fail-2.png)
...
## Next Steps
 - See the list of supported notifiers [here](/products/kubed/0.6.0-rc.0/guides/cluster-events/notifiers).
 - Learn how to use Kubed to protect your Kubernetes cluster from disasters [here](/products/kubed/0.6.0-rc.0/guides/disaster-recovery/).
