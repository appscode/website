...
| `recycleBin.receiver`      | `Optional`. If set, a notification will be sent when any supported object is deleted and/or updated. To learn how to use various notifiers, please visit [here](/products/kubed/0.6.0-rc.0/guides/cluster-events/notifiers). |
...
Now, deploy Kubed operator in your cluster following the steps [here](/products/kubed/0.6.0-rc.0/setup/install). Once the operator pod is running, go to the next section.
...
To uninstall Kubed operator, please follow the steps [here](/products/kubed/0.6.0-rc.0/setup/uninstall).

## Next Steps
 - Learn how to use Kubed to take periodic snapshots of a Kubernetes cluster [here](/products/kubed/0.6.0-rc.0/guides/disaster-recovery/cluster-snapshot).
