...
| `eventForwarder.receiver`                 | `Required`. To learn how to use various notifiers, please visit [here](/products/kubed/0.4.0/guides/cluster-events/notifiers). |
...
![PVC Added Notification](/products/kubed/0.4.0/images/event-forwarder/pvc-added-notification.png)
...
![Pod Failed](/products/kubed/0.4.0/images/event-forwarder/pod-fail-1.png)
![Pod FailedSync](/products/kubed/0.4.0/images/event-forwarder/pod-fail-2.png)
...
To uninstall Kubed operator, please follow the steps [here](/products/kubed/0.4.0/setup/uninstall).


## Next Steps
 - See the list of supported notifiers [here](/products/kubed/0.4.0/guides/cluster-events/notifiers).
