...
| `recycleBin.receiver`      | `Optional`. If set, a notification will be sent when any supported object is deleted and/or updated. To learn how to use various notifiers, please visit [here](/products/kubed/0.5.0/guides/cluster-events/notifiers). |
