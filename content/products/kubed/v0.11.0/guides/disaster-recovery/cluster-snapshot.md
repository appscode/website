...
Now, deploy Kubed operator in your cluster following the steps [here](/products/kubed/v0.11.0/setup/install). Once the operator pod is running, check your bucket from Google Cloud console. You should see the data from initial snapshot operation.

![GCS Snapshot](/products/kubed/v0.11.0/images/cluster-snapshot/gcs-snapshot.png)
...
Now, deploy Kubed operator in your cluster following the steps [here](/products/kubed/v0.11.0/setup/install). Once the operator pod is running, check your bucket from S3 console. You should see the data from initial snapshot operation.
...
Now, deploy Kubed operator in your cluster following the steps [here](/products/kubed/v0.11.0/setup/install). Once the operator pod is running, check your container from Azure portal. You should see the data from initial snapshot operation.
...
Now, deploy Kubed operator in your cluster following the steps [here](/products/kubed/v0.11.0/setup/install). Once the operator pod is running, check your container. You should see the data from initial snapshot operation.
...
## Cleaning up
To cleanup the Kubernetes resources created by this tutorial, uninstall Kubed operator following the steps [here](/products/kubed/v0.11.0/setup/uninstall).
...
## Next Steps
 ...
 - Backup your persistent volumes with [Stash](/products/kubed/v0.11.0/guides/disaster-recovery/stash).
