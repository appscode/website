...
![origin annotation](/products/kubed/v0.11.0/images/config-syncer/config-origin.png)
...
## Next Steps
 - Learn how to sync config-maps or secrets across multiple cluster [here](/products/kubed/v0.11.0/guides/config-syncer/inter-cluster).
