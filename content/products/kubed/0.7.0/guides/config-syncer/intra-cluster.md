...
![origin annotation](/products/kubed/0.7.0/images/config-syncer/config-origin.png)
...
To uninstall Kubed operator, please follow the steps [here](/products/kubed/0.7.0/setup/uninstall).


## Next Steps
 - Learn how to sync config-maps or secrets across multiple cluster [here](/products/kubed/0.7.0/guides/config-syncer/inter-cluster).
