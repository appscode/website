...
![release-list](/products/swift/0.6.0/images/release-list.png)


## Cleaning up

If you would like to uninstall Swift proxy, please follow the steps [here](/products/swift/0.6.0/setup/uninstall).
