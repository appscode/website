...
![release-list](/products/swift/0.8.1/images/release-list.png)


## Cleaning up

If you would like to uninstall Swift proxy, please follow the steps [here](/products/swift/0.8.1/setup/uninstall).
