...
- Add [tutorial](/products/swift/0.7.3/rbac) for RBAC enabled cluster [\#59](https://github.com/appscode/swift/pull/59)
...
First public release of Wheel. To install, please visit [here](/products/swift/0.7.3/setup/install).

 - JSON proxy for Helm Tiller apis. Tested with Helm 2.5.0 .
 - Supports connecting to Tiller server in [3 different modes](/products/swift/0.7.3/setup/install).
