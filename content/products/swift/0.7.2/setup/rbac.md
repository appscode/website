...
![release-list](/products/swift/0.7.2/images/release-list.png)


## Cleaning up

If you would like to uninstall Swift proxy, please follow the steps [here](/products/swift/0.7.2/setup/uninstall).
