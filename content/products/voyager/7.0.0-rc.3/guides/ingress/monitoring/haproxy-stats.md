...
Now, deploy Voyager operator following instructions [here](/products/voyager/7.0.0-rc.3/setup/install).
...
![stats-page](/products/voyager/7.0.0-rc.3/images/monitoring/stats-view.png)
...
- To monitor your HAProxy pods using builtin [Prometheus](https://prometheus.io/) scraper, visit [here](/products/voyager/7.0.0-rc.3/guides/ingress/monitoring/using-builtin-prometheus).
- To monitor your HAProxy pods using [CoreOS Prometheus Operator](/products/voyager/7.0.0-rc.3/guides/mongodb/monitoring/using-coreos-prometheus-operator), visit [here](/products/voyager/7.0.0-rc.3/guides/ingress/monitoring/using-coreos-prometheus-operator).
- To monitor Voyager operator using Prometheus, visit [here](/products/voyager/7.0.0-rc.3/guides/ingress/monitoring/operator-stats).
