...
To learn about necessary IAM permissions, please see [here](/products/voyager/7.1.0/guides/certificate/dns/route53).
...
If you are running your cluster on Google Cloud (GKE or GCE), Voyager can use default service account associated with a VM. Please see [here](/products/voyager/7.1.0/guides/certificate/dns/google-cloud) for detailed instructions.
