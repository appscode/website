...
> New to Voyager? Please start [here](/products/voyager/6.0.0-rc.0).
...
- [Using HTTP-01 challenge](/products/voyager/6.0.0-rc.0/guides/certificate/http)
- [Using DNS-01 challenge](/products/voyager/6.0.0-rc.0/guides/certificate/providers)
...
If you would like to uninstall Voyager operator, please follow the steps [here](/products/voyager/6.0.0-rc.0/setup/uninstall).
