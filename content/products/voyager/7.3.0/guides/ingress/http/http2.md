...
To enable http2, you must first setup a [certificate](/products/voyager/7.3.0/guides/certificate) (Let's Encrypt), or use an existing one. Then create an ingress object like below:
