...
Now, deploy Voyager operator following instructions [here](/products/voyager/7.2.0/setup/install).
...
![stats-page](/products/voyager/7.2.0/images/monitoring/stats-view.png)
...
- To monitor your HAProxy pods using builtin [Prometheus](https://prometheus.io/) scraper, visit [here](/products/voyager/7.2.0/guides/ingress/monitoring/using-builtin-prometheus).
- To monitor your HAProxy pods using [CoreOS Prometheus Operator](/products/voyager/7.2.0/guides/mongodb/monitoring/using-coreos-prometheus-operator), visit [here](/products/voyager/7.2.0/guides/ingress/monitoring/using-coreos-prometheus-operator).
- To monitor Voyager operator using Prometheus, visit [here](/products/voyager/7.2.0/guides/ingress/monitoring/operator-stats).
