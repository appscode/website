...
- First, install Voyager operator in your cluster following the steps [here](/products/voyager/v12.0.0-rc.1/setup/install).

- Now, deploy test servers using [this script](/products/voyager/v12.0.0-rc.1/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
