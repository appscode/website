...
Like this [issuer.yaml](/products/voyager/v12.0.0-rc.1/examples/cert-manager/issuer.yaml)
...
You can change that value using `duration` and `renewBefore` field in [certificate.yaml](/products/voyager/v12.0.0-rc.1/examples/cert-manager/certificate.yaml),
