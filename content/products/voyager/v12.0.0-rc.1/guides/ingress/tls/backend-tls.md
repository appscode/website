...
- `ca-file <file-path>`: Specify a CA file to verify the backend server. See [here](/products/voyager/v12.0.0-rc.1/guides/ingress/configuration/config-volumes) for complete example.
