...
![create-zone](/products/voyager/v12.0.0-rc.1/images/certificate/google-cloud/create-zone.png)

Once the zone is created, you can see the list of name servers in Google cloud console.

![ns-servers](/products/voyager/v12.0.0-rc.1/images/certificate/google-cloud/ns-servers.png)

Now, go to the website of your domain registrar and update the list of name servers.

![domain-registrar](/products/voyager/v12.0.0-rc.1/images/certificate/google-cloud/domain-registrar.png)
...
![create-svc-account](/products/voyager/v12.0.0-rc.1/images/certificate/google-cloud/create-svc-account.png)
...
![gke-permissions](/products/voyager/v12.0.0-rc.1/images/certificate/google-cloud/gke-permissions.png)
...
![acme-challenge](/products/voyager/v12.0.0-rc.1/images/certificate/google-cloud/acme-challenge.png)
...
![a-record](/products/voyager/v12.0.0-rc.1/images/certificate/google-cloud/a-record.png)
