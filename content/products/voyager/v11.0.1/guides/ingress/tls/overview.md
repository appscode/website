...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/products/voyager/v11.0.1/setup/install).
...
- [Using HTTP-01 challenge](/products/voyager/v11.0.1/guides/certificate/http/overview)
- [Using DNS-01 challenge](/products/voyager/v11.0.1/guides/certificate/dns/providers)
