...
![a-record](/products/voyager/v11.0.1/images/cert-manager/azure/a-record.png)
...
![new-registration](/products/voyager/v11.0.1/images/cert-manager/azure/new-registration.png)
![new-registration2](/products/voyager/v11.0.1/images/cert-manager/azure/new-registration2.png)

You'll need the `Application (client) ID` and `Directory (tenant) ID` later for creating issuer.

![client-tenant](/products/voyager/v11.0.1/images/cert-manager/azure/client-tenant.png)

Now, create a new client-secret.

![client-secret](/products/voyager/v11.0.1/images/cert-manager/azure/client-secret.png)
...
![subscriptions](/products/voyager/v11.0.1/images/cert-manager/azure/subscriptions.png)
...
![user-access](/products/voyager/v11.0.1/images/cert-manager/azure/user-access.png)
...
![dns-zone-contributor](/products/voyager/v11.0.1/images/cert-manager/azure/dns-zone-contributor.png)

Now create this issuer by applying [issuer.yaml](/products/voyager/v11.0.1/examples/cert-manager/azure/issuer.yaml)
...
Now, Create [ingress.yaml](/products/voyager/v11.0.1/examples/cert-manager/azure/ingress.yaml)
...
Then create this [certificate.yaml](/products/voyager/v11.0.1/examples/cert-manager/azure/certificate.yaml)
