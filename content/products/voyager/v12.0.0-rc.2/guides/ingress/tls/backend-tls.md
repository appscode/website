...
- `ca-file <file-path>`: Specify a CA file to verify the backend server. See [here](/products/voyager/v12.0.0-rc.2/guides/ingress/configuration/config-volumes) for complete example.
