...
Now, deploy Voyager operator following instructions [here](/products/voyager/v12.0.0-rc.2/setup/install).
...
![stats-page](/products/voyager/v12.0.0-rc.2/images/monitoring/stats-view.png)
...
- To monitor your HAProxy pods using builtin [Prometheus](https://prometheus.io/) scraper, visit [here](/products/voyager/v12.0.0-rc.2/guides/ingress/monitoring/using-builtin-prometheus).
- To monitor your HAProxy pods using [CoreOS Prometheus Operator](/products/voyager/v12.0.0-rc.2/guides/ingress/monitoring/using-coreos-prometheus-operator), visit [here](/products/voyager/v12.0.0-rc.2/guides/ingress/monitoring/using-coreos-prometheus-operator).
- To monitor Voyager operator using Prometheus, visit [here](/products/voyager/v12.0.0-rc.2/guides/ingress/monitoring/operator-stats).
