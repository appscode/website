...
![svcac1](/products/voyager/v12.0.0-rc.0/images/cert-manager/google_dns/svcac1.png)
![svcac2](/products/voyager/v12.0.0-rc.0/images/cert-manager/google_dns/svcac2.png)
![svcac3](/products/voyager/v12.0.0-rc.0/images/cert-manager/google_dns/svcac3.png)
...
Now create this issuer by applying [issuer.yaml](/products/voyager/v12.0.0-rc.0/examples/cert-manager/google_cloud/issuer.yaml)
...
Now, Create [ingress.yaml](/products/voyager/v12.0.0-rc.0/examples/cert-manager/google_cloud/ingress.yaml)
...
Then create this [certificate.yaml](/products/voyager/v12.0.0-rc.0/examples/cert-manager/google_cloud/certificate.yaml)
