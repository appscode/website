...
Setup a [ClusterIssuer (Or Issuer)](/products/voyager/v12.0.0-rc.0/guides/cert-manager/get-started) for your Ingress by applying
this [clusterissuer.yaml](/products/voyager/v12.0.0-rc.0/examples/cert-manager/http/clusterissuer.yaml)
...
Now create your ingress by applying [ingress.yaml](/products/voyager/v12.0.0-rc.0/examples/cert-manager/http/ingress.yaml)
