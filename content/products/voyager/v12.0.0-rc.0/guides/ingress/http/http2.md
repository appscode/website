...
To enable http2, you must first setup a [certificate](/products/voyager/v12.0.0-rc.0/guides/certificate) (Let's Encrypt), or use an existing one. Then create an ingress object like below:
