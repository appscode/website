...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/products/voyager/7.0.0-rc.2/setup/install).
...
- [Using HTTP-01 challenge](/products/voyager/7.0.0-rc.2/guides/certificate/http)
- [Using DNS-01 challenge](/products/voyager/7.0.0-rc.2/guides/certificate/providers)
...
If you would like to uninstall Voyager operator, please follow the steps [here](/products/voyager/7.0.0-rc.2/setup/uninstall).
