...
![create-hosted-zone](/products/voyager/6.0.0-rc.2/images/certificate/route53/create-hosted-zone.png)

Once the hosted zone is created, you can see the list of name servers in AWS console.

![ns-servers](/products/voyager/6.0.0-rc.2/images/certificate/route53/ns-servers.png)

Now, go to the website of your domain registrar and update the list of name servers.

![domain-registrar](/products/voyager/6.0.0-rc.2/images/certificate/route53/domain-registrar.png)
...
![master-iam-role](/products/voyager/6.0.0-rc.2/images/certificate/route53/master-iam-role.png)

- Go the [IAM roles console](https://console.aws.amazon.com/iam/home#/roles) and select the master IAM role for your cluster.

![master-role](/products/voyager/6.0.0-rc.2/images/certificate/route53/master-iam-role-console.png)

- Now add the custom inline policy show above.

![add-policy](/products/voyager/6.0.0-rc.2/images/certificate/route53/add-policy.png)
...
![acme-challenge](/products/voyager/6.0.0-rc.2/images/certificate/route53/acme-challenge.png)
...
![cname-record](/products/voyager/6.0.0-rc.2/images/certificate/route53/cname-record.png)
