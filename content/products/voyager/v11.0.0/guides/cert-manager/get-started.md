...
Like this [issuer.yaml](/products/voyager/v11.0.0/examples/cert-manager/issuer.yaml)
...
You can change that value using `duration` and `renewBefore` field in [certificate.yaml](/products/voyager/v11.0.0/examples/cert-manager/certificate.yaml),
