...
![iam](/products/voyager/v11.0.0/images/cert-manager/route53/iam.png)

![add-user](/products/voyager/v11.0.0/images/cert-manager/route53/add-user.png)

![access-type](/products/voyager/v11.0.0/images/cert-manager/route53/access-type.png)

Click on next and select `Attach existing policies directly` and click on `Create Policy`. This will take you to a new page.

![create-policy](/products/voyager/v11.0.0/images/cert-manager/route53/create-policy.png)
...
![review-policy](/products/voyager/v11.0.0/images/cert-manager/route53/review-policy.png)

Now go back to previous add user page, hit the refresh button and attach this policy to this user:

![attach-policy](/products/voyager/v11.0.0/images/cert-manager/route53/attach-policy.png)

Click on next (tags are optional - you can ignore this) and finish the process. Download the `.csv` file.

![success-user](/products/voyager/v11.0.0/images/cert-manager/route53/success-user.png)
...
![hosted-zone-id](/products/voyager/v11.0.0/images/cert-manager/route53/hosted-zone-id.png)

And put them in [issuer.yaml](/products/voyager/v11.0.0/examples/cert-manager/route53/issuer.yaml)
...
Now create [ingress.yaml](/products/voyager/v11.0.0/examples/cert-manager/route53/ingress.yaml):
...
![a-record](/products/voyager/v11.0.0/images/cert-manager/route53/a-record.png)

## 3. Create Certificate

Then create this [certificate.yaml](/products/voyager/v11.0.0/examples/cert-manager/route53/certificate.yaml)
