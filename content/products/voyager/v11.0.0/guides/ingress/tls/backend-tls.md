...
- `ca-file <file-path>`: Specify a CA file to verify the backend server. See [here](/products/voyager/v11.0.0/guides/ingress/configuration/config-volumes) for complete example.
