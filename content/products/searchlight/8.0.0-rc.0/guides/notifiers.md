...
![telegram-bot](/products/searchlight/8.0.0-rc.0/images/notifiers/telegram-bot.png)
...
## Next Steps
 - To periodically run various checks on your Kubernetes cluster, use [ClusterAlerts](/products/searchlight/8.0.0-rc.0/concepts/alert-types/cluster-alert).
