...
Voila! `component-status` command has been synced to Icinga2. Please visit [here](/products/searchlight/8.0.0-rc.0/guides/notifiers) to learn how to configure notifier secret. Now, open IcingaWeb2 in your browser. You should see a Icinga host `demo@cluster` and Icinga service `component-status-demo-0`.

![check-all-components](/products/searchlight/8.0.0-rc.0/images/cluster-alerts/component-status/demo-0.png)
...
```
![check-by-component-name](/products/searchlight/8.0.0-rc.0/images/cluster-alerts/component-status/demo-1.png)
