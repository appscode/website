...
Voila! `pod-exists` command has been synced to Icinga2. Please visit [here](/products/searchlight/8.0.0-rc.0/guides/notifiers) to learn how to configure notifier secret. Now, open IcingaWeb2 in your browser. You should see a Icinga host `demo@cluster` and Icinga service `pod-exists-demo-0`.

![check-all-pods](/products/searchlight/8.0.0-rc.0/images/cluster-alerts/pod-exists/demo-0.png)
...
```
![check-by-pod-label](/products/searchlight/8.0.0-rc.0/images/cluster-alerts/pod-exists/demo-1.png)
