...
To build and push your custom Docker image, follow the steps below. To release a new version of Searchlight, please follow the [release guide](/products/searchlight/8.0.0-rc.0/setup/developer-guide/release).
