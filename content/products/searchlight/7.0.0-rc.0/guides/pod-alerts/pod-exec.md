...
Voila! `pod-exec` command has been synced to Icinga2. Please visit [here](/products/searchlight/7.0.0-rc.0/guides/notifiers) to learn how to configure notifier secret. Now, open IcingaWeb2 in your browser. You should see a Icinga host `demo@pod@minikube` and Icinga service `pod-exec-demo-0`.

![check-all-pods](/products/searchlight/7.0.0-rc.0/images/pod-alerts/pod-exec/demo-0.png)
...
```
![check-by-pod-label](/products/searchlight/7.0.0-rc.0/images/pod-alerts/pod-exec/demo-1.png)
