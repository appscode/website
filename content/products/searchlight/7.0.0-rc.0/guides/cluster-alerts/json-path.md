...
Voila! `json-path` command has been synced to Icinga2. Please visit [here](/products/searchlight/7.0.0-rc.0/guides/notifiers) to learn how to configure notifier secret. Now, open IcingaWeb2 in your browser. You should see a Icinga host `demo@cluster` and Icinga service `json-path-demo-0`.

![check-all-pods](/products/searchlight/7.0.0-rc.0/images/cluster-alerts/json-path/demo-0.png)
