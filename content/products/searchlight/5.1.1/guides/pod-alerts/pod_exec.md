...
Voila! `pod_exec` command has been synced to Icinga2. Please visit [here](/products/searchlight/5.1.1/guides/notifiers) to learn how to configure notifier secret. Now, open IcingaWeb2 in your browser. You should see a Icinga host `demo@pod@minikube` and Icinga service `pod-exec-demo-0`.

![check-all-pods](/products/searchlight/5.1.1/images/pod-alerts/pod_exec/demo-0.png)
...
```
![check-by-pod-label](/products/searchlight/5.1.1/images/pod-alerts/pod_exec/demo-1.png)
