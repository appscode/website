...
![telegram-bot](/products/searchlight/5.1.0/images/notifiers/telegram-bot.png)
...
## Next Steps
 - To periodically run various checks on your Kubernetes cluster, use [ClusterAlerts](/products/searchlight/5.1.0/concepts/alert-types/cluster-alert).
