...
>Note: YAML files used in this tutorial are stored in [/docs/examples/backup](/products/stash/0.8.2/examples/backup) directory of [appscode/stash](https://github.com/appscode/stash) repository.
...
<p align="center">
  <img alt="Stash Backup Flow" src="/products/stash/0.8.2/images/stash-backup.svg">
</p>
...
Here, we can see 4 last successful backup [Snapshot](/products/stash/0.8.2/concepts/crds/snapshot) taken by Stash in `deployment.stash-demo` repository.
