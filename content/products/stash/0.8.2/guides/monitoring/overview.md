...
<p align="center">
  <img alt="Monitoring Structure"  src="/products/stash/0.8.2/images/monitoring/stash-monitoring-structure.png">
</p>
...
- Learn how to monitor Stash using built-in Prometheus from [here](/products/stash/0.8.2/guides/monitoring/builtin).
