...
- Learn how to use Stash in Google Kubernetes Engine (GKE) from [here](/products/stash/0.8.2/guides/platforms/gke).
- Learn how to use Stash to backup a Kubernetes deployment from [here](/products/stash/0.8.2/guides/backup).
- Learn how to recover from backed up snapshot from [here](/products/stash/0.8.2/guides/restore).