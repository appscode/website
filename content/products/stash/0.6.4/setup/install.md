...
$ kubectl apply -f https://raw.githubusercontent.com/appscode/stash/0.6.4/hack/deploy/without-rbac.yaml


# Install with RBAC roles
$ kubectl apply -f https://raw.githubusercontent.com/appscode/stash/0.6.4/hack/deploy/with-rbac.yaml
```
...
Now, you are ready to [take your first backup](/products/stash/0.6.4/guides/README) using Stash.
