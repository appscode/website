...
To use Stash in a RBAC enabled cluster, [install Stash](/products/stash/0.6.4/setup/install) with RBAC options. This creates a ClusterRole named `stash-sidecar`.
...
You can find full working examples [here](/products/stash/0.6.4/guides/workloads).
