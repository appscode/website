...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/rook](/products/stash/0.8.0/examples/platforms/rook) directory of [appscode/stash](https://github.com/appscode/stash) repository.
