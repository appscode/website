...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/minio](/products/stash/0.8.0/examples/platforms/minio) directory of [appscode/stash](https://github.com/appscode/stash) repository.
...
Here, we can see 5 last successful backup [Snapshot](/products/stash/0.8.0/concepts/crds/snapshot) taken by Stash in `deployment.stash-demo` repository.
...
<p align="center">
  <img alt="Repository in Minio Backend",  height="350px" src="/products/stash/0.8.0/images/platforms/minio/minio-repository.png">
</p>

To view the snapshot files, navigate to `snapshots` directory of the repository,

<p align="center">
  <img alt="Snapshot in Minio Bucket" height="350px" src="/products/stash/0.8.0/images/platforms/minio/minio-snapshots.png">
</p>
