...
- Learn how to use Stash in Amazon Elastic Container Service for Kubernetes (EKS) from [here](/products/stash/0.8.0/guides/platforms/eks).
- Learn how to use Stash with S3 compatible Mino Storage Server from [here](/products/stash/0.8.0/guides/platforms/minio).
- Learn how to use Stash with S3 comptatibe Rook Storage Service from [here](/products/stash/0.8.0/guides/platforms/rook).
