...
Enable Prometheus monitoring using `prometheus.io/builtin` agent while installing Stash. To know details about how to enable monitoring see [here](/products/stash/0.8.0/guides/monitoring/overview#how-to-enable-monitoring). Here, we are going to enable monitoring for both `backup & recovery` and `operator` metrics.
...
<p align="center">
  <img alt="Prometheus Target" src="/products/stash/0.8.0/images/monitoring/prom-builtin-target.png" style="padding:10px">
</p>
