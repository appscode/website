...
menu:
  product_stash_v0.9.0-rc.1:
    identifier: standalone-elasticsearch-5.6.4
    name: Backup & Restore Elasticsearch
    parent: stash-elasticsearch-guides-5.6.4
    weight: 10
product_name: stash
...
sample-elasticsearch   5.6.4-v1    Running   3m35s
```
...
metadata:
  labels:
    ...
    app.kubernetes.io/version: 5.6.4-v1
...
sample-elasticsearch-backup   elasticsearch-backup-5.6.4   */5 * * * *   true     3m8s
```
...
NAME                     VERSION     STATUS         AGE
restored-elasticsearch   5.6.4-v1    Initializing   38s
```
...
$ kubectl get es -n demo restored-elasticsearch
NAME                     VERSION     STATUS    AGE
restored-elasticsearch   5.6.4-v1    Running   2m16s
```
