...
<figure align="center">
 <img alt="MongoDB Backup Overview" src="/products/stash/v0.9.0-rc.1/images/addons/mongodb/backup_overview.svg">
...
<figure align="center">
 <img alt="Standalone MongoDB Backup Overview" src="/products/stash/v0.9.0-rc.1/images/addons/mongodb/standalone_backup.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Backup Overview" src="/products/stash/v0.9.0-rc.1/images/addons/mongodb/replicaset_backup.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Backup Overview" src="/products/stash/v0.9.0-rc.1/images/addons/mongodb/sharded_backup.svg">
...
<figure align="center">
 <img alt="Database Restore Overview" src="/products/stash/v0.9.0-rc.1/images/addons/mongodb/restore_overview.svg">
...
<figure align="center">
 <img alt="Standalone MongoDB Restore Overview" src="/products/stash/v0.9.0-rc.1/images/addons/mongodb/standalone_restore.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Restore Overview" src="/products/stash/v0.9.0-rc.1/images/addons/mongodb/replicaset_restore.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Restore" src="/products/stash/v0.9.0-rc.1/images/addons/mongodb/sharded_restore.svg">
  <figcaption align="center">Fig: MongoDB Sharded Cluster Restore</figcaption>
</figure>

## Next Steps

- Install MongoDB addon for Stash following the guide from [here](/products/stash/v0.9.0-rc.1/addons/mongodb/setup/install).
