...
menu:
  product_stash_v0.9.0-rc.1:
    identifier: mongodb-replicaset-4.0.11
...
sample-mgo-rs   4.0.11      Running   1m
```
...
sample-mgo-rs-backup  mongodb-backup-4.0.11        */5 * * * *   true     26m
```
...
NAME              VERSION     STATUS         AGE
restored-mgo-rs   4.0.11      Initializing   2m
```
...
$ kubectl get mg -n demo restored-mgo-rs
NAME              VERSION     STATUS    AGE
restored-mgo-rs   4.0.11      Running   3m
```
...
$ kubectl get mg -n demo restored-mongodb
NAME               VERSION     STATUS    AGE
restored-mongodb   4.0.11      Running   2m
```
