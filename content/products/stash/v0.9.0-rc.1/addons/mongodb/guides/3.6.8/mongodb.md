...
menu:
  product_stash_v0.9.0-rc.1:
    identifier: standalone-mongodb-3.6.8
    name: Standalone MongoDB
    parent: stash-mongodb-guides-3.6.8
    weight: 10
product_name: stash
...
sample-mongodb   3.6.8     Running   2m9s
```
...
sample-mongodb-backup  mongodb-backup-3.6.8        */5 * * * *   true     26m
```
...
NAME               VERSION   STATUS         AGE
restored-mongodb   3.6.8     Initializing   17s
```
...
$ kubectl get mg -n demo restored-mongodb
NAME               VERSION   STATUS    AGE
restored-mongodb   3.6.8     Running   105m
```
