...
menu:
  product_stash_v0.9.0-rc.1:
    identifier: standalone-mongodb-4.1.4
    name: Standalone MongoDB
    parent: stash-mongodb-guides-4.1.4
    weight: 10
product_name: stash
...
sample-mongodb   4.1.4         Running   2m9s
```
...
sample-mongodb-backup  mongodb-backup-4.1.4        */5 * * * *   true     26m
```
...
NAME               VERSION       STATUS         AGE
restored-mongodb   4.1.4         Initializing   17s
```
...
$ kubectl get mg -n demo restored-mongodb
NAME               VERSION       STATUS    AGE
restored-mongodb   4.1.4         Running   105m
```
