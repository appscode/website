...
menu:
  product_stash_v0.9.0-rc.1:
    identifier: standalone-mongodb-3.4.22
    name: Standalone MongoDB
    parent: stash-mongodb-guides-3.4.22
    weight: 10
product_name: stash
...
sample-mongodb   3.4.22    Running   2m9s
```
...
sample-mongodb-backup  mongodb-backup-3.4.22        */5 * * * *   true     26m
```
...
NAME               VERSION   STATUS         AGE
restored-mongodb   3.4.22    Initializing   17s
```
...
$ kubectl get mg -n demo restored-mongodb
NAME               VERSION   STATUS    AGE
restored-mongodb   3.4.22    Running   105m
```
