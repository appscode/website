...
<figure align="center">
  <img alt="Auto Backup Overview" src="/products/stash/v0.9.0-rc.1/images/guides/latest/auto-backup/auto_backup_overview.svg">
...
7. Finally, Stash starts rest of the standard backup process as discussed in [here](/products/stash/v0.9.0-rc.1/guides/latest/workload/overview).
...
- Learn how to configure automatic backup for workloads from [here](/products/stash/v0.9.0-rc.1/guides/latest/auto-backup/workload).
- Learn how to configure automatic backup for PVCs from [here](/products/stash/v0.9.0-rc.1/guides/latest/auto-backup/pvc).
- Learn how to configure automatic backup for databases from [here](/products/stash/v0.9.0-rc.1/guides/latest/auto-backup/database).
