...
>**Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/latest/auto-backup/pvc](/products/stash/v0.9.0-rc.1/examples/guides/latest/auto-backup/pvc) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Backup data of PVC 'nfs-pvc' in GCS backend" src="/products/stash/v0.9.0-rc.1/images/guides/latest/auto-backup/pvc/pvc_repo.png">
