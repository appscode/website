...
Enable Prometheus monitoring using `prometheus.io/coreos-operator` agent while installing Stash. To know details about how to enable monitoring see [here](/products/stash/v0.9.0-rc.1/guides/v1alpha1/monitoring/overview#how-to-enable-monitoring).
...
<p align="center">
  <img alt="Prometheus Target" src="/products/stash/v0.9.0-rc.1/images/v1alpha1/monitoring/prom-coreos-target.png" style="padding:10px">
</p>
