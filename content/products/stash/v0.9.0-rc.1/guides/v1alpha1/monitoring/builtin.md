...
<p align="center">
  <img alt="Prometheus Target" src="/products/stash/v0.9.0-rc.1/images/v1alpha1/monitoring/prom-builtin-target.png" style="padding:10px">
</p>
...
- Learn how to use Grafana dashboard to visualize monitoring data from [here](/products/stash/v0.9.0-rc.1/guides/v1alpha1/monitoring/grafana).
