...
<p align="center">
  <img alt="Stash Offline Backup Flow" src="/products/stash/v0.9.0-rc.1/images/v1alpha1/stash-offline-backup.svg">
</p>
...
Here, we are going to backup the `/source/data` folder of a `busybox` pod into an [NFS](https://kubernetes.io/docs/concepts/storage/volumes/#nfs) volume. NFS volume is a type of [local](/products/stash/v0.9.0-rc.1/guides/v1alpha1/backends/local) backend for Stash.
