...
- Learn how backup of workloads data works from [here](/products/stash/v0.9.0-rc.1/guides/latest/workloads/overview).
- Learn how backup of databases works from [here](/products/stash/v0.9.0-rc.1/guides/latest/databases/overview).
- Learn how backup stand alone PVC works from [here](/products/stash/v0.9.0-rc.1/guides/latest/volumes/overview).
