...
<p align="center">
  <img alt="Stash Offline Backup Flow" src="/products/stash/0.8.1/images/stash-offline-backup.svg">
</p>
...
Here, we are going to backup the `/source/data` folder of a `busybox` pod into an [NFS](https://kubernetes.io/docs/concepts/storage/volumes/#nfs) volume. NFS volume is a type of [local](/products/stash/0.8.1/guides/backends/local) backend for Stash.
