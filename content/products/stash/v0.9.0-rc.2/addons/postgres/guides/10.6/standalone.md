...
menu:
  product_stash_v0.9.0-rc.2:
    identifier: standalone-postgres-10.6
    name: Standalone PostgreSQL
    parent: stash-postgres-guides-10.6
    weight: 10
product_name: stash
...
- Install PostgreSQL addon for Stash following the steps [here](/products/stash/v0.9.0-rc.2/addons/postgres/setup/install)
...
- If you are not familiar with how Stash backup and restore PostgreSQL databases, please check the following guide [here](/products/stash/v0.9.0-rc.2/addons/postgres/overview):
...
Here, we have to use service `sample-postgres` and secret `sample-postgres-auth` to connect with the database. KubeDB creates an [AppBinding](/products/stash/v0.9.0-rc.2/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
...
sample-postgres-backup  postgres-backup-10.6        */5 * * * *   true     26m
```
