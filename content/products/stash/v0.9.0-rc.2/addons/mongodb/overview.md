...
<figure align="center">
 <img alt="MongoDB Backup Overview" src="/products/stash/v0.9.0-rc.2/images/addons/mongodb/backup_overview.svg">
...
3. Then, she creates a `BackupConfiguration` crd targeting the [AppBinding](/products/stash/v0.9.0-rc.2/concepts/crds/appbinding) crd of the desired database. The `BackupConfiguration` object also specifies the `Task` to use to backup the database.
...
<figure align="center">
 <img alt="Standalone MongoDB Backup Overview" src="/products/stash/v0.9.0-rc.2/images/addons/mongodb/standalone_backup.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Backup Overview" src="/products/stash/v0.9.0-rc.2/images/addons/mongodb/replicaset_backup.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Backup Overview" src="/products/stash/v0.9.0-rc.2/images/addons/mongodb/sharded_backup.svg">
...
<figure align="center">
 <img alt="Database Restore Overview" src="/products/stash/v0.9.0-rc.2/images/addons/mongodb/restore_overview.svg">
...
<figure align="center">
 <img alt="Standalone MongoDB Restore Overview" src="/products/stash/v0.9.0-rc.2/images/addons/mongodb/standalone_restore.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Restore Overview" src="/products/stash/v0.9.0-rc.2/images/addons/mongodb/replicaset_restore.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Restore" src="/products/stash/v0.9.0-rc.2/images/addons/mongodb/sharded_restore.svg">
  <figcaption align="center">Fig: MongoDB Sharded Cluster Restore</figcaption>
</figure>

## Next Steps

- Install MongoDB addon for Stash following the guide from [here](/products/stash/v0.9.0-rc.2/addons/mongodb/setup/install).
