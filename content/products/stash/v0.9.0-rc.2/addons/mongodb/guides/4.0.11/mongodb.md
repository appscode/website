...
menu:
  product_stash_v0.9.0-rc.2:
    identifier: standalone-mongodb-4.0.11
    name: Standalone MongoDB
    parent: stash-mongodb-guides-4.0.11
    weight: 10
product_name: stash
...
sample-mongodb   4.0.11      Running   2m9s
```
...
sample-mongodb-backup  mongodb-backup-4.0.11        */5 * * * *   true     26m
```
...
NAME               VERSION     STATUS         AGE
restored-mongodb   4.0.11      Initializing   17s
```
...
$ kubectl get mg -n demo restored-mongodb
NAME               VERSION     STATUS    AGE
restored-mongodb   4.0.11      Running   105m
```
