...
menu:
  product_stash_v0.9.0-rc.2:
    identifier: standalone-elasticsearch-6.8.0
    name: Backup & Restore Elasticsearch
    parent: stash-elasticsearch-guides-6.8.0
    weight: 10
product_name: stash
...
sample-elasticsearch   6.8.0           Running   3m35s
```
...
NAME                     VERSION       STATUS         AGE
restored-elasticsearch   6.8.0         Initializing   38s
```
...
$ kubectl get es -n demo restored-elasticsearch
NAME                     VERSION       STATUS    AGE
restored-elasticsearch   6.8.0         Running   2m16s
```
