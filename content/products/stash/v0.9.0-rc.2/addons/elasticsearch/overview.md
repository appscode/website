...
<figure align="center">
 <img alt="Elasticsearch Backup Overview" src="/products/stash/v0.9.0-rc.2/images/addons/elasticsearch/backup_overview.svg">
...
<figure align="center">
 <img alt="Database Restore Overview" src="/products/stash/v0.9.0-rc.2/images/addons/elasticsearch/restore_overview.svg">
...
- Install Elasticsearch addon for Stash following the guide from [here](/products/stash/v0.9.0-rc.2/addons/elasticsearch/setup/install).
