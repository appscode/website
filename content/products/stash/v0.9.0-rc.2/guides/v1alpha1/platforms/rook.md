...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/rook](/products/stash/v0.9.0-rc.2/examples/platforms/rook) directory of [stashed/docs](https://github.com/stashed/docs) repository.
