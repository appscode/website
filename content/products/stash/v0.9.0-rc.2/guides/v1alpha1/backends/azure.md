...
- Learn how to use Stash in Azure Kubernetes Service (AKS) from [here](/products/stash/v0.9.0-rc.2/guides/v1alpha1/platforms/aks).
- Learn how to use Stash to backup a Kubernetes deployment from [here](/products/stash/v0.9.0-rc.2/guides/v1alpha1/backup).
- Learn how to recover from backed up snapshot from [here](/products/stash/v0.9.0-rc.2/guides/v1alpha1/restore).
