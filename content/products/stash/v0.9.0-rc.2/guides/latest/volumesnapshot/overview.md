...
<figure align="center">
  <img alt="Stash Backup Flow" src="/products/stash/v0.9.0-rc.2/images/guides/latest/volumesnapshot/volumesnapshot-overview.svg">
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/products/stash/v0.9.0-rc.2/images/guides/latest/volumesnapshot/restore-overview.svg">
...
1. See a step by step guide to snapshot the volumes of a Deployment [here](/products/stash/v0.9.0-rc.2/guides/latest/volumesnapshot/deployment).
2. See a step by step guide to snapshot the volumes of a StatefulSet [here](/products/stash/v0.9.0-rc.2/guides/latest/volumesnapshot/statefulset).
3. See a step by step guide to snapshot a stand-alone PVC [here](/products/stash/v0.9.0-rc.2/guides/latest/volumesnapshot/pvc).
