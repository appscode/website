...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/platforms/rook](/products/stash/v0.9.0-rc.2/examples/guides/latest/platforms/rook) directory of [stashed/doc](https://github.com/stashed/doc) repository.
