...
> **Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/latest/platforms/eks](/products/stash/v0.9.0-rc.2/examples/guides/latest/platforms/eks) directory of [stashed/doc](https://github.com/stashed/doc) repository.
...
<figure align="center">
  <img alt="Backup data in AWS s3 Bucket" src="/products/stash/v0.9.0-rc.2/images/guides/latest/platforms/eks.png">
