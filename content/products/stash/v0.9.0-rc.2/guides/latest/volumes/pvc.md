...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/volumes](/products/stash/v0.9.0-rc.2/examples/guides/latest/volumes) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Backed up data of a stand-alone PVC in GCS backend" src="/products/stash/v0.9.0-rc.2/images/guides/latest/volumes/pvc_repo.png">
