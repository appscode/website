...
> **Note:** YAML files used in this tutorial are stored in [/docs/examples/guides/latest/advanced-use-case/clone-pvc](/products/stash/v0.9.0-rc.2/examples/guides/latest/advanced-use-case/clone-pvc) directory of [stashed/docs](https://github.com/stashed/docs) repository.
