...
<figure align="center">
  <img alt="Stash Backup Flow" src="/products/stash/v0.9.0-rc.2/images/guides/latest/workloads/backup_overview.svg">
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/products/stash/v0.9.0-rc.2/images/guides/latest/workloads/restore_overview.svg">
...
1. See a step by step guide to backup/restore volumes of a Deployment [here](/products/stash/v0.9.0-rc.2/guides/latest/workloads/deployment).
2. See a step by step guide to backup/restore volumes of a StatefulSet [here](/products/stash/v0.9.0-rc.2/guides/latest/workloads/statefulset).
3. See a step by step guide to backup/restore a Daemonset's volumes [here](/products/stash/v0.9.0-rc.2/guides/latest/workloads/daemonset).
