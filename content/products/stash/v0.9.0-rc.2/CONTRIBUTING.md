...
url: /products/stash/v0.9.0-rc.2/welcome/contributing/
aliases:
- /products/stash/v0.9.0-rc.2/CONTRIBUTING/
info:
  version: v0.9.0-rc.2
---
...
We have a [Developer Guide](/products/stash/v0.9.0-rc.2/setup/developer-guide/overview) that outlines everything you need to know from setting up your
