...
A `Repository` is a Kubernetes `CustomResourceDefinition`(CRD) which represents [backend](/products/stash/v0.9.0-rc.2/guides/latest/backends/overview) information in a Kubernetes native way.
...
- **spec.backend**
`spec.backend` specifies the storage location where the backed up snapshots will be stored. To learn how to configure `Repository` crd for  various backends, please visit [here](/products/stash/v0.9.0-rc.2/guides/latest/backends/overview).
...
- Learn how to create `Repository` crd for different backends from [here](/products/stash/v0.9.0-rc.2/guides/latest/backends/overview).
- Learn how Stash backup workloads data from [here](/products/stash/v0.9.0-rc.2/guides/latest/workloads/overview).
- Learn how Stash backup databases from [here](/products/stash/v0.9.0-rc.2/guides/latest/databases/overview).
