...
You can find the full working demo in [examples folder](/products/stash/0.7.0-rc.5/examples/workloads/statefulset.yaml). The section you should change for your own StatefulSet are:
...
To learn about the meaning of various flags, please visit [here](/products/stash/0.7.0-rc.5/reference/stash_backup).
...
- Wondering what features are coming next? Please visit [here](/products/stash/0.7.0-rc.5/roadmap).
