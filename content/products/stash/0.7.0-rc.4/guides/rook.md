...
Now, let’s backup the directory into a [AWS S3](/products/stash/0.7.0-rc.4/guides/backends#aws-s3) compatible Rook Object Storage.
...
Uninstall Stash following the instructions [here](/products/stash/0.7.0-rc.4/setup/uninstall).