...
url: /products/stash/0.7.0-rc.2/welcome/contributing/
aliases:
- /products/stash/0.7.0-rc.2/CONTRIBUTING/
info:
  version: 0.7.0-rc.2
---
...
We have a [Developer Guide](/products/stash/0.7.0-rc.2/setup/developer-guide/overview) that outlines everything you need to know from setting up your
