...
> **Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/latest/platforms/minio](/products/stash/v0.9.0-rc.0/examples/guides/latest/platforms/minio) directory of [stashed/doc](https://github.com/stashed/doc) repository.
...
<figure align="center">
  <img alt="Backup data in Minio Bucket" src="/products/stash/v0.9.0-rc.0/images/guides/latest/platforms/minio.png">
