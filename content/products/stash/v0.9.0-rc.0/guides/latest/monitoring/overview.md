...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/products/stash/v0.9.0-rc.0/images/guides/latest/monitoring/stash-monitoring-structure.svg">
...
- Learn how to monitor Stash using built-in Prometheus from [here](/products/stash/v0.9.0-rc.0/guides/latest/monitoring/builtin).
