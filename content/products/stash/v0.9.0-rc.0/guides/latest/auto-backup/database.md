...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/auto-backup/database](/products/stash/v0.9.0-rc.0/examples/guides/latest/auto-backup/database) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
We are going to use [GCS Backend](/products/stash/v0.9.0-rc.0/guides/latest/backends/gcs) to store the backed up data. You can use any supported backend you prefer. You just have to configure Storage Secret and `spec.backend` section of `BackupBlueprint` to match with your backend. To learn which backends are supported by Stash and how to configure them, please visit [here](/products/stash/v0.9.0-rc.0/guides/latest/backends/overview).
...
<figure align="center">
  <img alt="Backup data of PostgreSQL 'sample-postgres-1' in GCS backend" src="/products/stash/v0.9.0-rc.0/images/guides/latest/auto-backup/database/sample_postgres_1.png">
...
<figure align="center">
  <img alt="Backup data of PostgreSQL 'sample-postgres-2' in GCS backend" src="/products/stash/v0.9.0-rc.0/images/guides/latest/auto-backup/database/sample_postgres_2.png">
