...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/workloads](/products/stash/v0.9.0-rc.0/examples/guides/latest/workloads) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
We are going to store our backed up data into a GCS bucket. We have to create a Secret with necessary credentials and a Repository crd to use this backend. If you want to use a different backend, please read the respective backend configuration doc from [here](/products/stash/v0.9.0-rc.0/guides/latest/backends/overview).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/products/stash/v0.9.0-rc.0/images/guides/latest/workloads/gcs_bucket_dep.png">
