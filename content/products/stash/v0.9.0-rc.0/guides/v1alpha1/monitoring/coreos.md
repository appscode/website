...
Enable Prometheus monitoring using `prometheus.io/coreos-operator` agent while installing Stash. To know details about how to enable monitoring see [here](/products/stash/v0.9.0-rc.0/guides/v1alpha1/monitoring/overview#how-to-enable-monitoring).
...
<p align="center">
  <img alt="Prometheus Target" src="/products/stash/v0.9.0-rc.0/images/v1alpha1/monitoring/prom-coreos-target.png" style="padding:10px">
</p>
...
To uninstall Stash follow this [guide](/products/stash/v0.9.0-rc.0/setup/uninstall).
...
- Learn how to use Grafana dashboard to visualize monitoring data from [here](/products/stash/v0.9.0-rc.0/guides/v1alpha1/monitoring/grafana).
