...
>Note: YAML files used in this tutorial are stored in [/docs/examples/backup](/products/stash/v0.9.0-rc.0/examples/backup) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<p align="center">
  <img alt="Stash Backup Flow" src="/products/stash/v0.9.0-rc.0/images/v1alpha1/stash-backup.svg">
</p>
...
Here, we can see 4 last successful backup [Snapshot](/products/stash/v0.9.0-rc.0/concepts/crds/snapshot) taken by Stash in `deployment.stash-demo` repository.
