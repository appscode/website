...
Uninstall old `Stash` operator by following the instructions [here](/products/stash/0.6.0/setup/uninstall).
...
Install new `Stash` operator by following the instructions [here](/products/stash/0.6.0/setup/install).
