...
Enable Prometheus monitoring using `prometheus.io/builtin` agent while installing Stash. To know details about how to enable monitoring see [here](/products/stash/0.8.3/guides/monitoring/overview#how-to-enable-monitoring). Here, we are going to enable monitoring for both `backup & recovery` and `operator` metrics.
...
```console
$ kubectl apply -f https://raw.githubusercontent.com/appscode/stash/0.8.3/docs/examples/monitoring/builtin/prom-rbac.yaml
...
```console
$ kubectl apply -f https://raw.githubusercontent.com/appscode/stash/0.8.3/docs/examples/monitoring/builtin/prom-config.yaml
...
```console
$ kubectl apply -f https://raw.githubusercontent.com/appscode/stash/0.8.3/docs/examples/monitoring/builtin/prom-deployment.yaml
...
<p align="center">
  <img alt="Prometheus Target" src="/products/stash/0.8.3/images/monitoring/prom-builtin-target.png" style="padding:10px">
</p>
...
To uninstall Stash follow this [guide](/products/stash/0.8.3/setup/uninstall).
...
- Learn how to use Grafana dashboard to visualize monitoring data from [here](/products/stash/0.8.3/guides/monitoring/grafana).