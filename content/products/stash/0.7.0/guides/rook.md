...
Now, let’s backup the directory into a [AWS S3](/products/stash/0.7.0/guides/backends#aws-s3) compatible Rook Object Storage.
...
Uninstall Stash following the instructions [here](/products/stash/0.7.0/setup/uninstall).